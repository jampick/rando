  ...
  return (
    <div className="space-y-6">
      ...
      <div className="text-center">
        ...
        <h1 className="text-3xl font-bold text-gray-900">About WorkerBooBoo</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="card">
            <div className="flex items-start">
              ...
              <div className="ml-4">
                <h3 className="text-lg font-medium text-gray-900">Interactive Mapping</h3>
          ...
          <div className="card">
            <div className="flex items-start">
              ...
              <div className="ml-4">
                <h3 className="text-lg font-medium text-gray-900">Safety Resources</h3>
                <p className="text-gray-600 mt-1">
      ...
      <div className="card">
        ...
        <div className="space-y-4">
          <div>
            <h3 className="text-lg font-medium text-gray-900">OSHA Data</h3>
            <p className="text-gray-600 mt-1">
          ...
          <div>
            <h3 className="text-lg font-medium text-gray-900">Data Updates</h3>
            <p className="text-gray-600 mt-1">
      ...
      {/* Safety Resources */}
      <div>
        <h2 className="text-2xl font-bold text-gray-900 mb-4">Safety Resources</h2>
      ...
      <div className="card bg-gradient-to-r from-green-50 to-emerald-50 border-green-200">
        <h2 className="text-xl font-semibold text-green-900 mb-4">Essential Safety Tips</h2>
